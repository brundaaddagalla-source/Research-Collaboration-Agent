...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:5173",
        "http://127.0.0.1:5173",
        "https://research-collaboration-agent.vercel.app",
    ],
...
app.include_router(auth.router, tags=["Faculty Auth"])
app.include_router(collaboration_requests.router, tags=["Collaboration Requests"])
